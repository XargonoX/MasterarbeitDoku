...
\section{Vision}\label{Vision}\todo{In Anforderungen Umbenennen?}
...
Für den Client des Therapeuten sind dies die in Tabelle \ref{FunktionaleAnforderungenTherapeutClient} dargestellten Anforderungen.

\begin{tabular}{|l|c|}
	\label{FunktionaleAnforderungenTherapeutClient}
	Anforderung & Beschreibung \\
	\hline
	Patientenverwaltung & Die Patienten sollen mit ihren Persönlichen Daten verwaltet werden können \\ \hline
	Aufgabenverwaltung & Es muss möglich sein, Aufgaben zu erstellen und die Patienten zuzuweisen \\ \hline 
	Materialien & Den Aufgaben sollen verschiedenste Materialien angehängt werden können \\ \hline
	Kontrollmechanismen & Der Therapeut soll den Aufgaben Kontrollmechanismen hinzufügen können\\ \hline
	Fragebogenverwaltung & Es sollen Fragebögen mit antwortabhängigen  \\ & Fragen erstellt und den Patienten zugewiesen werden können \\
\end{tabular} 
\todo{Startereignisse}
\todo{Kontrollmechanismen} 
\todo{funktionale Anforderungen an Fragebogenerstellung, welche Fragetypen}
...
\begin{tabular}{|l|c|}
	...
	Anforderung & Beschreibung \\
	\hline
	User Identifikation & Der Patient stellt Verbindung zu dem von Therapeut erstellten Profil her \\
	Aufgabenanzeige & Übersicht der zugewiesenen Therapeutischen Aufgaben \\
	Detailanzeige der Aufgabe  & Eine detaillierte Anzeige der Aufgabe mit Name, Erklärung und angefügten Materialien\\
	Anzeige der Materialien & Die angehängten Materialien müssen vom Patienten innerhalb des Clients eingesehen werden können\\
	Verändern des Erledigungskontext & Der von Therapeuten vorgegebene Erledigungskontext soll vom Patienten veränderbar sein \\
...
\begin{table}
	\begin{tabular}{|l||p{10cm}|}
		\rowcolor{blue!10} Anforderung & Beschreibung \\
		\hline
		Datenpersistenz & Die vom Therapeuten eingegebene Daten müssen persistent gespeichert werden \\
		\rowcolor{black!10} globale Datenpersistenz & Die gespeicherten Daten sollen auf allen Geräten synchron sein \\
		Plattform unabhängig & Die Anwendung soll von möglichst vielen Geräten aus verwendet werden können \\ \bottomrule
	\end{tabular}
...
\section{Patienten Client} \todo{Architekturbild}
...
\todo{factory : ApiServer kurz erwähnen}
